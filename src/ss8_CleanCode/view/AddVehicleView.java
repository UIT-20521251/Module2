...
public class AddVehicleView {
    ...
    public static Car addCarMenu() {
        ...
        return new Car(licensePlate, brandName, productionYear, owner,numberOfSeats, carType);
    }
    public static Motorbike addMotorbikeMenu() {
        ...
        return new Motorbike(licensePlate, brandName, productionYear, owner,horsepower);
    }
    public static Truck addTruckMenu() {
        ...
        return new Truck(licensePlate, brandName, productionYear, owner,loadCapacity);
    }
}
